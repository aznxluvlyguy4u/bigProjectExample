...
class Constant
{
    ...
    const NEW_USER_MAIL_SUBJECT_HEADER_ADMIN = "Een nieuwe gebruiker heeft zich geregistreerd voor NSFO online";
    const NEW_USER_MAIL_SUBJECT_HEADER_USER = "U bent geregistreerd voor NSFO online";
