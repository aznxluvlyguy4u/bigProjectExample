    ...
    public static function createHistoryResponse($declarations)
    {
        ...
        foreach ($declarations as $declaration) {
            ...
            $res[] = array(
              ...
              "mother_collar_color" => Utils::fillNull($declaration['mother_collar_color']),
              "mother_collar_number" => Utils::fillNull($declaration['mother_collar_number']),
              "father_collar_color" => Utils::fillNull($declaration['father_collar_color']),
              "father_collar_number" => Utils::fillNull($declaration['father_collar_number']),
