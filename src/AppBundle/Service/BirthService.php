...
class BirthService extends DeclareControllerServiceBase implements BirthAPIControllerInterface
{
    ...
    public function getCandidateFathers(Request $request, $uln)
    {
        ...
        $otherCandidateFathers = $this->getManager()->getRepository(Animal::class)->getLiveStock($location, $this->getCacheService(), true, false, false, Ram::class);
    ...
    public function getCandidateMothers(Request $request) {
        ...
        $motherCandidates = $this->getManager()->getRepository(Animal::class)->getLiveStock($location , $this->getCacheService(), true, false, false, Ewe::class);
