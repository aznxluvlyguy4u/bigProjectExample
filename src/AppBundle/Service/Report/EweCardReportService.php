...
class EweCardReportService extends ReportServiceBase
{
    ...
    public function getReport($actionBy, Location $location, ArrayCollection $content)
    {
        ...
        return $this->getPdfReport($content);
    }
     ...
     * @return JsonResponse
     */
    private function getPdfReport(ArrayCollection $content)
    {
    ...
    public function getData(ArrayCollection $content) {
        $useTestValues = true;
        ...
        foreach ($animalIds as $animalId) {
            $data[$animalId] = [
                'animalAndProduction' => $this->filterDataForAnimalId($animalId, $animalAndProductionValues),
...
ORDER BY a.parent_mother_id, a.litter_id
";
