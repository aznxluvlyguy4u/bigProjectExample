...
class WeightsPerYearOfBirthReportService extends ReportServiceBase
{
    ...
    private function getSqlQuery(int $yearOfBirth, ?Location $location = null)
    {
        ...
        return "SELECT
            ...
            to_char(weight_data.measurement_date_1, 'DD-MM-YYYY') as datum_meting_1,
            weight_data.weight_measurement_1 as gewicht_meting_1,
            to_char(weight_data.measurement_date_2,'DD-MM-YYYY') as datum_meting_2,
            weight_data.weight_measurement_2 as gewicht_meting_2,
            to_char(weight_data.measurement_date_3, 'DD-MM-YYYY') as datum_meting_3,
            weight_data.weight_measurement_3 as gewicht_meting_3,
            to_char(weight_data.measurement_date_4, 'DD-MM-YYYY') as datum_meting_4,
            weight_data.weight_measurement_4 as gewicht_meting_4,
            to_char(weight_data.measurement_date_5, 'DD-MM-YYYY') as datum_meting_5,
            weight_data.weight_measurement_5 as gewicht_meting_5,
            to_char(weight_data.measurement_date_6, 'DD-MM-YYYY') as datum_meting_6,
            weight_data.weight_measurement_6 as gewicht_meting_6,
            to_char(weight_data.measurement_date_7, 'DD-MM-YYYY') as datum_meting_7,
            weight_data.weight_measurement_7 as gewicht_meting_7,
            to_char(weight_data.measurement_date_8, 'DD-MM-YYYY') as datum_meting_8,
            weight_data.weight_measurement_8 as gewicht_meting_8,
            to_char(weight_data.measurement_date_9, 'DD-MM-YYYY') as datum_meting_9,
            weight_data.weight_measurement_9 as gewicht_meting_9,
            to_char(weight_data.measurement_date_10, 'DD-MM-YYYY') as datum_meting_10,
