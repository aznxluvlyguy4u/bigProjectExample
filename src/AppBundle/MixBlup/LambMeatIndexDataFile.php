...
class LambMeatIndexDataFile extends MixBlupDataFileBase implements MixBlupDataFileInterface
{
     ...
     * @return array
     */
    private function generateTestAttributeInstructionFile()
    {
        $start = [
            'TITEL   schapen fokwaarde berekening vleeslamkenmerken',
        ...
        return ArrayUtil::concatArrayValues([$start, $this->getStandardizedBreedCodePartsAndHetRecOfInstructionFile(),
            $middle, $this->getInstructionFileDefaultEnding()]);
    }
    ...
    {
        return [$this->generateTestAttributeInstructionFile()];
    }
