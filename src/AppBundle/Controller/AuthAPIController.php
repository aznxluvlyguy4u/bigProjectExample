...
class AuthAPIController extends APIController {
  ...
  /**
   * Change passwords for clients and print them out.
   *
   * @param Request $request the request object
   * @return JsonResponse
   * @Route("/change-passwords-with-dump")
   * @Method("PUT")
   *
   * @param Request $request
   */
  public function changePasswordsOrMultipleClients(Request $request)
  {
//    $admin = $this->getAuthenticatedEmployee($request);
//    $adminValidator = new AdminValidator($admin, AccessLevelType::DEVELOPER);
...
//    $sourceFilePath = '/home/data/JVT/projects/NSFO/Migratie/FirstEmailList/nsfo_passwords_2016-08-04_NieuweEmailAdressen_GebruikersMetUbn';
    ...
    return new JsonResponse(['Passwords successfully changed' => $successCount,
                             'Clients not found' => $failCount], 200);
  }
