...
class UserActionType extends RequestType
{
    ...
    const ADMIN_EMAIL_CHANGE = 'ADMIN_EMAIL_CHANGE';
    const USER_EMAIL_CHANGE = 'USER_EMAIL_CHANGE';
    const VWA_EMAIL_CHANGE = 'VWA_EMAIL_CHANGE';
    ...
    const ANIMAL_RESIDENCE_CREATE = 'ANIMAL_RESIDENCE_CREATE';
    const ANIMAL_RESIDENCE_EDIT = 'ANIMAL_RESIDENCE_EDIT';
    const ANIMAL_RESIDENCE_DELETE = 'ANIMAL_RESIDENCE_DELETE';
    ...
    const ANIMAL_HEALTH_SUBSCRIPTION_UPDATE = 'ANIMAL_HEALTH_SUBSCRIPTION_UPDATE';
    ...
    const ADMIN_ANIMAL_CREATE = 'ADMIN_ANIMAL_CREATE';
    const ADMIN_ANIMAL_EDIT = 'ADMIN_ANIMAL_EDIT';

    const RVO_LEADING_ANIMAL_SYNC = 'RVO_LEADING_ANIMAL_SYNC';

    const TREATMENT_CREATE = 'TREATMENT_CREATE';
    const TREATMENT_EDIT = 'TREATMENT_EDIT';
    const TREATMENT_DELETE = 'TREATMENT_DELETE';
    const TREATMENT__REACTIVATE = 'TREATMENT_REACTIVATE';
    ...
    const TREATMENT_TEMPLATE_REACTIVATE = 'TREATMENT_TEMPLATE_REACTIVATE';

    const TREATMENT_MEDICATION_CREATE = 'TREATMENT_MEDICATION_CREATE';
    const TREATMENT_MEDICATION_DELETE = 'TREATMENT_MEDICATION_DELETE';
