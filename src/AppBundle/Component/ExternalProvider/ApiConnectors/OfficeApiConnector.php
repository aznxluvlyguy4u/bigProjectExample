...
namespace AppBundle\Component\ExternalProvider\ApiConnectors;
...
class OfficeApiConnector extends BaseApiConnector
{
     ...
     * @return Office
     */
    private function createOffice($resultObject): Office
    {
        $office = new Office();
        $office->setCode($resultObject->string[0]);
        $office->setCountryCode($resultObject->string[2]);
        $office->setName($resultObject->string[1]);
        return $office;
    }
}
