...
class AnimalCriteria
{
     ...
     * @return Criteria
     */
    public static function sortByDateOfBirth(bool $sortAscending = true): Criteria
    {
        return Criteria::create()->orderBy(['dateOfBirth' => ($sortAscending ? Criteria::ASC : Criteria::DESC)]);
    }
